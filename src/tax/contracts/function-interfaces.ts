 ...
 */
export type GenerateTaxReportFunction = (
 ...
 */
export type GetTaxOptimizationFunction = (
 ...
 */
export type ExportTaxReportPDFFunction = (
	report: TaxReport,
 ...
 */
export type ExportTaxReportATOFunction = (
	report: TaxReport,
 ...
 */
export type GetSupportedJurisdictionsFunction = () => TaxJurisdiction[];

/**
 * Calculate cost basis for a disposal using specified method
 */
export type CalculateCostBasisFunction = (
 ...
 */
export type ClassifyTransactionFunction = (
 ...
 */
export type CalculateCapitalGainsFunction = (
	disposal: Transaction,
	costBasis: CostBasis,
	jurisdiction: string,
) => CapitalGainsResult;
 ...
 */
export type InitializeStorageFunction = (
 ...
 */
export type StoreTransactionsFunction = (
 ...
 */
export type RetrieveTransactionsFunction = (
 ...
 */
export type GenerateTaxReportCLIFunction = (
	options: CLITaxReportOptions,
) => Promise<void>;
...
export type ValidateTransactionsFunction = (
	transactions: Transaction[],
	jurisdiction: string,
) => ValidationResult;

export type ValidateTaxReportFunction = (report: TaxReport) => ValidationResult;
...
export interface TaxTestUtilities {
	...
	createTestJurisdiction: (
		overrides?: Partial<TaxJurisdiction>,
	) => TaxJurisdiction;
