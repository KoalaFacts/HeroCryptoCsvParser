...
export class CSVExporter {
  ...
  exportToCSV(
    ...
    for (const transaction of report.transactions) {
      lines.push(
        this.formatTransaction(transaction, delimiter, dateFormat, includeOptimizationNotes)
      );
    }
   ...
   */
  private generateHeaders(delimiter: string, includeOptimizationNotes: boolean): string {
    const headers = [
      'Date',
      'Type',
      'Asset',
