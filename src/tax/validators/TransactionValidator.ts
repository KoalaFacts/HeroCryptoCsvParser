...
import { getTransactionTimestamp, getBaseAmount, getTransactionAsset } from '../utils/transactionHelpers';
...
export class TransactionValidator {
  ...
  validateTaxableTransaction(
    ...
    const baseResult = this.validateTransaction(taxableTransaction.originalTransaction, options);
   ...
   */
  private validateRequiredFields(transaction: Transaction, issues: ValidationIssue[]): void {
    // Transaction ID
   ...
   * Validate data types
   */
  private validateDataTypes(transaction: Transaction, issues: ValidationIssue[]): void {
  ...
  private validateTaxableAmounts(
    ...
    const { capitalGain, capitalLoss, incomeAmount, deductibleAmount } = taxableTransaction;
   ...
   */
  private buildResult(issues: ValidationIssue[], strict?: boolean): ValidationResult {
