...
describe("BinanceTransactionRecord", () => {
	...
	describe("parsing Binance CSV", () => {
		it("should parse valid Binance transaction", () => {
			const csvLine =
				"123456,2024-01-15 10:30:00,Spot,Buy,BTC,0.5,Buy BTC with USDT";
		...
		it("should handle deposit operation", () => {
			const csvLine =
				"123456,2024-01-15 10:30:00,Spot,Deposit,BTC,1.5,Deposit from wallet";
		...
		it("should handle withdrawal operation", () => {
			const csvLine =
				"123456,2024-01-15 10:30:00,Spot,Withdraw,BTC,-0.5,Withdraw to wallet";
		...
		it("should handle staking operations", () => {
			const csvLine =
				"123456,2024-01-15 10:30:00,Earn,Staking Rewards,ETH,0.05,ETH staking reward";
		...
		it("should handle fee operations", () => {
			const csvLine =
				"123456,2024-01-15 10:30:00,Spot,Fee,BNB,-0.001,Trading fee";
	...
	describe("output", () => {
		it("should output valid CSV line", () => {
			...
			expect(output).toBe(
				"123456,2024-01-15 10:30:00,Spot,Buy,BTC,0.5,Buy BTC",
			);
		});
	});
});
