...
describe('T010: Contract Test - classifyTransaction Function', () => {
  ...
  describe('Function Interface Contract', () => {
    it('should have classifyTransaction function available', () => {
      ...
      expect(() => {
        const classifyTransaction = require('../../../src/tax/classifyTransaction').classifyTransaction as ClassifyTransactionFunction;
    ...
    it('should accept transaction, jurisdiction, and optional context parameters', () => {
      ...
      try {
        ...
        const resultWithContext = classifyTransaction(mockTransaction, jurisdiction, context);
        expect(resultWithContext).toBeDefined();

        // Function should work without context
        const resultWithoutContext = classifyTransaction(mockTransaction, jurisdiction);
  ...
  describe('Input Validation Contract', () => {
    ...
    it('should validate required jurisdiction parameter', () => {
      ...
      try {
        ...
        expect(() => classifyTransaction(mockTransaction, null as any)).toThrow();

        // Test with undefined jurisdiction
        expect(() => classifyTransaction(mockTransaction, undefined as any)).toThrow();
    ...
    it('should validate jurisdiction is supported', () => {
      ...
      try {
        ...
        expect(() => classifyTransaction(mockTransaction, 'INVALID'))
    ...
    it('should handle optional context parameter', () => {
      ...
      try {
        ...
        const resultWithContext = classifyTransaction(mockTransaction, 'AU', mockContext);
        expect(resultWithContext).toBeDefined();
    ...
    it('should validate transaction has required fields', () => {
      ...
      try {
        ...
        expect(() => classifyTransaction(incompleteTransaction, 'AU'))
          .toThrow(/transaction|required|missing/i);
  ...
  describe('Context-Aware Classification Contract', () => {
    it('should use previous transactions for context', () => {
      ...
      try {
        ...
        const resultWithContext = classifyTransaction(transaction, 'AU', contextWithHistory);
    ...
    it('should consider portfolio holdings in classification', () => {
      ...
      try {
        ...
        const result = classifyTransaction(transaction, 'AU', contextWithPortfolio);
    ...
    it('should consider investor profile for business vs personal classification', () => {
      ...
      try {
        ...
        const personalResult = classifyTransaction(transaction, 'AU', personalContext);
        const businessResult = classifyTransaction(transaction, 'AU', businessContext);
  ...
  describe('Output Contract Validation', () => {
    it('should return valid TransactionTaxTreatment structure', () => {
      ...
      try {
        ...
        expect(['DISPOSAL', 'ACQUISITION', 'INCOME', 'DEDUCTIBLE', 'NON_TAXABLE'])
    ...
    it('should provide meaningful treatment reasons', () => {
      ...
      try {
        ...
        const hasRelevantKeywords = ['capital', 'income', 'deductible', 'disposal', 'acquisition', 'personal', 'business']
  ...
  describe('Error Handling Contract', () => {
    ...
    it('should handle malformed transaction data', () => {
      ...
      try {
        ...
        expect(() => classifyTransaction(malformedTransaction, 'AU'))
    ...
    it('should handle edge cases in classification logic', () => {
      ...
      try {
        ...
        expect(() => classifyTransaction(edgeTransaction, 'AU'))
          .toThrow(/amount|zero|invalid/i);
