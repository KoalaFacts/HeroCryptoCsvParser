...
describe('T009: Contract Test - calculateCostBasis Function', () => {
  ...
  describe('Function Interface Contract', () => {
    it('should have calculateCostBasis function available', () => {
      ...
      expect(() => {
        const calculateCostBasis = require('../../../src/tax/calculateCostBasis').calculateCostBasis as CalculateCostBasisFunction;
    ...
    it('should return CostBasis object', () => {
      const disposal = createMockDisposal('2024-06-15T10:00:00Z', 1);
      const acquisitions = [createMockAcquisition('2024-01-15T10:00:00Z', 2, 50000)];
  ...
  describe('Input Validation Contract', () => {
    it('should validate required disposal parameter', () => {
      ...
      try {
        ...
        expect(() => calculateCostBasis(null as any, acquisitions, 'FIFO')).toThrow();

        // Test with undefined disposal
        expect(() => calculateCostBasis(undefined as any, acquisitions, 'FIFO')).toThrow();
    ...
    it('should validate acquisitions array parameter', () => {
      ...
      try {
        ...
        expect(() => calculateCostBasis(disposal, null as any, 'FIFO')).toThrow();

        // Test with undefined acquisitions
        expect(() => calculateCostBasis(disposal, undefined as any, 'FIFO')).toThrow();
    ...
    it('should validate CostBasisMethod parameter', () => {
      ...
      try {
        ...
        // Test valid methods
        const validMethods: CostBasisMethod[] = ['FIFO', 'SPECIFIC_IDENTIFICATION'];
        ...
        // Test invalid method
        expect(() => calculateCostBasis(disposal, acquisitions, 'INVALID' as any))
    ...
    it('should handle empty acquisitions array', () => {
      ...
      try {
        ...
        expect(() => calculateCostBasis(disposal, emptyAcquisitions, 'FIFO'))
  ...
  describe('FIFO Method Contract', () => {
    it('should implement FIFO method correctly', () => {
      ...
      try {
        ...
        expect(result.acquisitionDate).toEqual(new Date('2024-01-15T10:00:00Z'));
    ...
    it('should calculate holding period from earliest acquisition for FIFO', () => {
      ...
      try {
        ...
        const expectedHoldingPeriod = Math.floor(
          (new Date('2024-06-15T10:00:00Z').getTime() - new Date('2024-01-15T10:00:00Z').getTime())
          / (1000 * 60 * 60 * 24)
        );
  ...
  describe('Specific Identification Method Contract', () => {
    it('should implement specific identification method', () => {
      ...
      try {
        ...
        const result = calculateCostBasis(disposal, acquisitions, 'SPECIFIC_IDENTIFICATION');
    ...
    it('should optimize cost basis selection for specific identification', () => {
      ...
      try {
        ...
        expect(result.acquisitionDate).toEqual(new Date('2024-02-15T10:00:00Z'));
  ...
  describe('Output Contract Validation', () => {
    ...
    it('should calculate total cost correctly', () => {
      ...
      try {
        ...
        const calculatedTotal = result.lots.reduce((sum, lot) => sum + (lot.amount * lot.unitPrice), 0);
  ...
  describe('Error Handling Contract', () => {
    it('should handle chronological validation', () => {
      ...
      const acquisitions = [createMockAcquisition('2024-06-15T10:00:00Z', 2, 50000)];

      try {
        const calculateCostBasis = require('../../../src/tax/calculateCostBasis').calculateCostBasis as CalculateCostBasisFunction;

        // Should either throw error or handle gracefully
        expect(() => calculateCostBasis(disposal, acquisitions, 'FIFO'))
    ...
    it('should handle malformed transaction data', () => {
      ...
      try {
        ...
        expect(() => calculateCostBasis(disposal, [malformedAcquisition], 'FIFO'))
