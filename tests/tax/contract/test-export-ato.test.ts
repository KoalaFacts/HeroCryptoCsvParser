...
describe('T007: Contract Test - exportTaxReportATO Function', () => {
  ...
  describe('Function Interface Contract', () => {
    it('should have exportTaxReportATO function available', () => {
      ...
      expect(() => {
        const exportTaxReportATO = require('../../../src/tax/exportTaxReportATO').exportTaxReportATO as ExportTaxReportATOFunction;
  ...
  describe('Input Validation Contract', () => {
    it('should validate required TaxReport parameter', async () => {
      ...
      try {
        ...
        await expect(exportTaxReportATO(null as any, mockOptions)).rejects.toThrow();

        // Test with undefined report
        await expect(exportTaxReportATO(undefined as any, mockOptions)).rejects.toThrow();
    ...
    it('should validate required ATOExportOptions parameter', async () => {
      ...
      try {
        ...
        await expect(exportTaxReportATO(mockReport, null as any)).rejects.toThrow();

        // Test with undefined options
        await expect(exportTaxReportATO(mockReport, undefined as any)).rejects.toThrow();
    ...
    it('should validate TFN format for individual taxpayers', async () => {
      ...
      try {
        ...
        await expect(exportTaxReportATO(mockReport, invalidTFNOptions))
          .rejects
          .toThrow(/TFN|invalid|format/i);
    ...
    it('should validate ABN format for business taxpayers', async () => {
      ...
      try {
        ...
        await expect(exportTaxReportATO(mockReport, invalidABNOptions))
          .rejects
          .toThrow(/ABN|invalid|format/i);
    ...
    it('should require either TFN or ABN but not both', async () => {
      ...
      try {
        ...
        await expect(exportTaxReportATO(mockReport, bothOptions))
          .rejects
          .toThrow(/TFN.*ABN|ABN.*TFN/i);

        // Neither TFN nor ABN should be rejected
        const neitherOptions: ATOExportOptions = {
          validateBeforeExport: true
        };
        await expect(exportTaxReportATO(mockReport, neitherOptions))
          .rejects
          .toThrow(/TFN|ABN|required/i);
    ...
    it('should validate jurisdiction is AU', async () => {
      ...
      try {
        ...
        await expect(exportTaxReportATO(nonAUReport, mockOptions))
          .rejects
          .toThrow(/jurisdiction|Australia|AU/i);
  ...
  describe('Error Handling Contract', () => {
    it('should validate report data when validation is enabled', async () => {
      ...
      try {
        ...
        await expect(exportTaxReportATO(invalidReport, {
          tfn: '123456789',
          validateBeforeExport: true
    ...
    it('should handle empty report gracefully', async () => {
      ...
      try {
        ...
        const result = await exportTaxReportATO(emptyReport, createMockATOOptions());
    ...
    it('should throw meaningful error for malformed data', async () => {
      ...
      try {
        ...
        await expect(exportTaxReportATO(malformedReport, createMockATOOptions()))
          .rejects
          .toThrow(/required|missing|invalid/i);
