...
import { TaxEvent } from '../../../src/types/common/TaxEvent';
...
export const createMockAsset = (symbol: string = 'BTC', name?: string): Asset => {
...
export const createMockDataSource = (name: string = 'TestExchange'): DataSource => {
...
export const createMockAssetAmount = (value: number = 1.0, asset?: Asset): AssetAmount => {
  return {
...
export const createMockSpotTrade = (overrides?: Partial<SpotTrade>): SpotTrade => {
  const baseDefault: SpotTrade = {
    ...
    quoteAsset: createMockAssetAmount(75000, createMockAsset('AUD', 'Australian Dollar')),
    side: 'SELL',
    price: '50000'
  };
...
export const createMockTransaction = (type: string = 'SPOT_TRADE', overrides?: Partial<Transaction>): Transaction => {
  if (type === 'SPOT_TRADE') {
