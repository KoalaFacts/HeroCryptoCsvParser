...
class TestAdapter extends SourceAdapter<TestRecord> {
  ...
  protected convertRecord(record: TestRecord, options?: ConversionOptions): Transaction {
...
describe('SourceAdapter', () => {
  ...
  describe('convert', () => {
    it('should convert records to transactions', () => {
      ...
      expect((result.transactions[0] as SpotTrade).baseAsset.asset.symbol).toBe('BTC');
  ...
  describe('metadata calculation', () => {
    it('should calculate date range', () => {
      ...
      expect(result.metadata.startDate).toEqual(new Date('2024-01-01T00:00:00Z'));
