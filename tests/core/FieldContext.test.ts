...
describe('FieldContext', () => {
  ...
  describe('FieldMapperContext', () => {
    ...
    it('should handle null raw value', () => {
      const record = new TestRecord();
      const context = new FieldMapperContext('Optional', 3, null as any, record);
    ...
    it('should handle special characters in raw value', () => {
      const record = new TestRecord();
      const context = new FieldMapperContext('Special', 1, 'Line1\nLine2\t\r\n', record);
  ...
  describe('FieldFormatterContext', () => {
    ...
    it('should handle null and undefined values', () => {
      ...
      const context2 = new FieldFormatterContext('Undefined', undefined, record);
    ...
    it('should handle complex object values', () => {
      ...
      const context = new FieldFormatterContext('Complex', complexValue, record);
  ...
  describe('FieldValidatorContext', () => {
    it('should create validator context', () => {
      const record = new TestRecord();
      const context = new FieldValidatorContext('Email', 'test@example.com', record);
  ...
  describe('Context inheritance', () => {
    it('should share common properties across contexts', () => {
      ...
      const formatterCtx = new FieldFormatterContext('Field3', 'formatted', record);
      const validatorCtx = new FieldValidatorContext('Field4', 'validate', record);
  ...
  describe('Edge cases', () => {
    ...
    it('should handle unicode in field names and values', () => {
      ...
      const context = new FieldMapperContext(unicodeName, 0, unicodeValue, record);
    ...
    it('should handle large field index values', () => {
      const record = new TestRecord();
      const context = new FieldMapperContext('Large', Number.MAX_SAFE_INTEGER, 'value', record);
