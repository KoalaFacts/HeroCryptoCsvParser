...
import { FieldDescriptor, FieldDefinition, FieldLocator } from '@/core/FieldDescriptor';
import { BatchEntryRecord } from '@/core/BatchEntryRecord';
import { FieldMapperContext, FieldFormatterContext, FieldValidatorContext, FieldGetterContext } from '@/core/FieldContext';
...
describe('FieldDescriptor', () => {
  ...
  describe('field types', () => {
    it('should handle string fields', () => {
      ...
      field.setWith((ctx, value) => { ctx.record.name = value; });
    ...
    it('should handle number fields', () => {
      ...
      field.setWith((ctx, value) => { ctx.record.age = value; });
    ...
    it('should handle boolean fields', () => {
      ...
      field.setWith((ctx, value) => { ctx.record.active = value; });
