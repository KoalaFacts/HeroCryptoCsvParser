...
describe('FieldValidationBuilder', () => {
  describe('required validation', () => {
    ...
    it('should handle null and undefined', () => {
      ...
      const contextUndefined = new FieldValidatorContext('testField', undefined, record);
      const contextEmpty = new FieldValidatorContext('testField', '', record);
      const contextSpaces = new FieldValidatorContext('testField', '  ', record);
  ...
  describe('notNull validation', () => {
    it('should validate not null', () => {
      ...
      const contextNull = new FieldValidatorContext('testField', null, record);
      const contextValue = new FieldValidatorContext('testField', 'value', record);
      const contextEmpty = new FieldValidatorContext('testField', '', record);
  ...
  describe('equal/notEqual validation', () => {
    it('should validate equal', () => {
      const builder = new FieldValidationBuilder<TestRecord, string>('testField');
      const validator = builder.equal('expected', 'Must equal expected').build();
      const record = new TestRecord();
      
      const context1 = new FieldValidatorContext('testField', 'expected', record);
    ...
    it('should validate notEqual', () => {
      const builder = new FieldValidationBuilder<TestRecord, string>('testField');
      const validator = builder.notEqual('forbidden', 'Cannot be forbidden').build();
      const record = new TestRecord();
      
      const context1 = new FieldValidatorContext('testField', 'forbidden', record);
      const context2 = new FieldValidatorContext('testField', 'allowed', record);
  ...
  describe('notEmpty validation', () => {
    it('should validate not empty', () => {
      ...
      const contextSpaces = new FieldValidatorContext('testField', '  ', record);
      const contextValue = new FieldValidatorContext('testField', 'value', record);
      const contextEmptyArray = new FieldValidatorContext('testField', [], record);
      const contextFilledArray = new FieldValidatorContext('testField', [1], record);
  ...
  describe('regex validation', () => {
    it('should validate regex patterns', () => {
      const builder = new FieldValidationBuilder<TestRecord>('testField');
      const validator = builder.regex(/^\d{3}-\d{3}-\d{4}$/, 'Invalid phone').build();
      const record = new TestRecord();
      
      const context1 = new FieldValidatorContext('testField', '123-456-7890', record);
      const context2 = new FieldValidatorContext('testField', '1234567890', record);
      const context3 = new FieldValidatorContext('testField', '123-456-789', record);
  ...
  describe('length validations', () => {
    it('should validate minimum length', () => {
      ...
      const context5 = new FieldValidatorContext('testField', [1, 2, 3], record);
    ...
    it('should validate maximum length', () => {
      ...
      const context4 = new FieldValidatorContext('testField', [1, 2, 3], record);
      const context5 = new FieldValidatorContext('testField', [1, 2, 3, 4, 5, 6], record);
  ...
  describe('oneOf validation', () => {
    it('should validate value is in allowed list', () => {
      const builder = new FieldValidationBuilder<TestRecord, string>('testField');
      const validator = builder.oneOf(['red', 'green', 'blue'], 'Invalid color').build();
      const record = new TestRecord();
    ...
    it('should work with numeric values', () => {
      const builder = new FieldValidationBuilder<TestRecord, number>('testField');
  ...
  describe('chaining validations', () => {
    it('should chain multiple validations', () => {
      ...
      const context3 = new FieldValidatorContext('testField', 'abcdefghijk', record);
      const result3 = validator(context3);
      expect(result3.isValid).toBe(false);
      expect(result3.errors[0].message).toBe('Too long');
      
      const context4 = new FieldValidatorContext('testField', 'perfect', record);
  ...
  describe('conditional validation', () => {
    it('should handle conditional validation with when', () => {
      ...
      const context1 = new FieldValidatorContext('testField', 'special', record);
      const result1 = validator(context1);
      expect(result1.isValid).toBe(false);
      
      const context2 = new FieldValidatorContext('testField', 'special_long_value', record);
      const result2 = validator(context2);
      expect(result2.isValid).toBe(true);
    ...
    it('should handle empty values correctly', () => {
      ...
      const validator2 = builder2.required('Required').minLength(5, 'Too short').build();
      const context2 = new FieldValidatorContext('testField', '', record);
  ...
  describe('edge cases', () => {
    it('should handle special characters', () => {
      ...
      const context4 = new FieldValidatorContext('testField', 'undefined', record);
    ...
    it('should handle very long strings', () => {
      ...
      const context = new FieldValidatorContext('testField', longString, record);
    ...
    it('should handle numeric edge cases', () => {
      ...
      const context4 = new FieldValidatorContext('testField', -Infinity, record);
