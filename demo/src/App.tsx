            ...
            <div className="flex items-center justify-between h-16">
              ...
              <div className="flex items-center space-x-4">
                <div className="hidden sm:flex items-center space-x-3">
                  <a href="https://github.com" className="inline-flex items-center px-3 py-1.5 text-sm font-medium text-base-content/60 hover:text-base-content transition-colors duration-200">
                  ...
                  <a href="https://npmjs.com" className="inline-flex items-center px-3 py-1.5 text-sm font-medium text-base-content/60 hover:text-base-content transition-colors duration-200">
                    <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-16 px-6 relative overflow-hidden">
              ...
              <div className="relative bg-gradient-to-r from-primary/95 to-secondary/95 rounded-3xl p-12 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                  <a
                    href="https://github.com/yourusername/hero-crypto-csv-parser"
                  ...
                  <a
                    href="https://www.npmjs.com/package/hero-crypto-csv-parser"
